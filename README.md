...
## Environments
- Preview: https://main--demo-richemont--aemysites.aem.page/
- Live: https://main--demo-richemont--aemysites.aem.live/
- Block Library: https://main--demo-richemont--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `demo-richemont` directory in your favorite IDE and start coding :)
